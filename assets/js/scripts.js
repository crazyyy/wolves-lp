...
$(function() {
  // second block change background image
  // https://jsfiddle.net/prasadraja07/Lr559q0b/4/
  var arrayOfPartenaires = [];
  $('.block-first--gallery a').each(function(index, el) {
    var image = $(this).attr('href');
    arrayOfPartenaires.push(image)
  });
  ...
  function cycleImages() {
    ...
    $(".block-first .block-first--bg").css({
